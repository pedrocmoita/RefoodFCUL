...
if(isset($_POST['submit-btn'])){
    ...
    $password = htmlspecialchars($_POST['password']);
        ...
        $select_query = "SELECT * FROM Instituicao WHERE email='$email'";
        ...
        if(mysqli_num_rows($result_select) == 0){
                if(strlen("$password") < 6 || strlen("$password") > 20){
                    ...
                    $error = "Number must have a maximum of 9 digits.";
                    echo "<div style='position: absolute; top: 3%; left: 50%; transform: translate(-50%, -50%);' class='container mt-3 pt-4 pb-4 alert alert-danger alert-dismissible fade show' role='alert'>
                                <button type='button' class='pt-4 close' data-dismiss='alert'>&times;</button>
                                {$error}
                        </div>";
        ...
        <div class="container">
            <form action="" method="post" class="institution p-5 m-5" id="form-institution">
                ...
                <p class="mt-3 mb-3">Adress</p>
                    ...
                    <div class="row">
                        <input class="col-lg ml-3 mr-3 mt-2 mb-2 pl-1" type="text" placeholder="adress" name="adress" required>
                        <div class="col-lg ml-3 mr-3 mt-2 mb-2 pl-1"></div>
                        <div class="col-lg ml-3 mr-3 mt-2 mb-2 pl-1"></div>
                    </div>
                <p class="mt-3 mb-3">Final steps</p>
                    <div class="row">
                        <input class="col-lg ml-3 mr-3 mt-2 mb-2 pl-1" type="text" placeholder="name person in charge" name="name_charge" required>
                        <input class="col-lg ml-3 mr-3 mt-2 mb-2 pl-1" type="tel" placeholder="number person in charge" name="number_charge" required>
                        <input class="col-lg ml-3 mr-3 mt-2 mb-2 pl-1" type="password" placeholder="password" name="password" id="password-institution" required>
                    </div>
                    <hr>
                    <div class="row m-3">
