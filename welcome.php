              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <input type="text" id="" name="name" value="Pedro"><br>
                    <input type="email" id="" name="email" value="pedrocmaster28@gmail.com"><br>
                    <input type="password" id="" name="password" value="12345678910"><br>
                  </div>
                  <!-- Modal footer -->
